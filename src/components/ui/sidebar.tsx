...
const Sidebar = React.forwardRef<HTMLDivElement, React.ComponentProps<"div"> & {
  ...
  if (collapsible === "none") {
    return <div className={cn("flex h-full w-[--sidebar-width] flex-col bg-theme-dark-lighter text-sidebar-foreground", className)} ref={ref} {...props}>
          {children}
        </div>;
  }
  if (isMobile) {
    return <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent data-sidebar="sidebar" data-mobile="true" className="w-[--sidebar-width] bg-theme-dark-lighter p-0 text-sidebar-foreground [&>button]:hidden" style={{
  ...
  return <div ref={ref} className="group peer hidden md:block text-sidebar-foreground bg-theme-dark-lighter" data-state={state} data-collapsible={state === "collapsed" ? collapsible : ""} data-variant={variant} data-side={side}>
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({
  ...
  return <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2 bg-theme-dark-lighter", className)} {...props} />;
});
